...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    {{-- <a class="nav-link {{(request()->is('admin/checkup/create')) ? '' : 'collapsed' }}" href="{{ route('checkup.create') }}"> --}}
  ...
  <li class="nav-item">
    ...
    {{-- <a class="nav-link {{(request()->is('admin/reports')) ? '' : 'collapsed' }}" href="{{ route('reports') }}"> --}}
